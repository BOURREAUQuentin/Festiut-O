...
CREATE TABLE SPECTATEUR (
  ...
  nomUtilisateurS VARCHAR(42) UNIQUE NOT NULL,
  mdpS VARCHAR(100) NOT NULL,
...
CREATE TABLE ARTISTE (
  ...
  courteDescriptionA VARCHAR(100) NOT NULL,
  longueDescriptionA VARCHAR(1024) NOT NULL,
...
CREATE TABLE LIEU (
  idL INT(40) NOT NULL,
  nomL VARCHAR(42) UNIQUE NOT NULL,
...
CREATE TABLE JOURNEE (
  idJ INT(40) NOT NULL,
  dateJ DATE UNIQUE CHECK (dateJ BETWEEN '2024-07-18' AND '2024-07-19'),
  PRIMARY KEY (idJ)
);
...
CREATE TABLE ACHETER (
  idB INT(40) NOT NULL,
  idS INT(3) NOT NULL,
  quantiteB INT(2) NOT NULL CHECK (quantiteB > 0),
  PRIMARY KEY (idB, idS),
  FOREIGN KEY (idB) REFERENCES BILLET (idB),
  FOREIGN KEY (idS) REFERENCES SPECTATEUR (idS)
);
