CREATE TABLE STYLE_MUSICAL (
  ...
  caracteristiqueSt VARCHAR(42) NOT NULL,
  PRIMARY KEY (idSt)
);
...
CREATE TABLE SPECTATEUR (
  ...
  adresseS VARCHAR(42) NOT NULL,
  cpS INT(5) NOT NULL,
  villeS VARCHAR(42) NOT NULL,
  paysS VARCHAR(42) NOT NULL,
...
CREATE TABLE ARTISTE (
  ...
  prenomA VARCHAR(42) NOT NULL,
  ageA INT(2) CHECK (ageA > 0),
...
CREATE TABLE JOURNEE (
  idJ INT(40) NOT NULL,
  dateJ DATE CHECK (dateJ BETWEEN '2024-07-18' AND '2024-07-20'),
  PRIMARY KEY (idJ)
);
...
CREATE TABLE HEBERGEMENT (
  ...
  nbPlaceH INT(3) CHECK (nbPlaceH > 0),
  idG INT(40) NOT NULL,
  PRIMARY KEY (idH),
  FOREIGN KEY (idG) REFERENCES GROUPE (idG)
);
...
CREATE TABLE RESEAU_SOCIAL (
  idR INT(40) NOT NULL,
  nomR VARCHAR(42) NOT NULL,
  lienR VARCHAR(100) NOT NULL,
  idG INT(40) NOT NULL,
  PRIMARY KEY (idR),
  FOREIGN KEY (idG) REFERENCES GROUPE (idG)
);
