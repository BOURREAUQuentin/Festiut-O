...
(9, 'Bono', 'Chanteur de U2', "Bono est le leader du groupe U2, connu pour ses performances énergiques et son engagement social. Sa voix distinctive et son activisme ont marqué la scène musicale mondiale.", 'bono.jpeg'),
(10, 'James Hetfield', 'Chanteur et guitariste de Metallica', "James Hetfield est le chanteur et guitariste principal du groupe Metallica. Il est reconnu pour ses compétences de guitariste et sa voix rauque, contribuant au succès durable de Metallica dans le heavy metal.", 'jameshetfield.jpg'),
(11, 'Mick Jagger', 'Chanteur des Rolling Stones', "Mick Jagger est le légendaire chanteur des Rolling Stones. Son énergie sur scène, son charisme et son style inimitable ont solidifié sa place parmi les icônes du rock.", 'mickjagger.jpg'),
(12, 'Chester Bennington', 'Chanteur de Linkin Park', "Chester Bennington était le regretté chanteur de Linkin Park. Sa voix puissante et émotionnelle a laissé une empreinte indélébile sur la scène musicale, en particulier dans le genre nu-metal.", 'chesterbennington.jpg'),
(13, 'Win Butler', "Chanteur d'Arcade Fire", "Win Butler est le chanteur principal du groupe Arcade Fire. Son approche artistique novatrice et ses performances passionnées ont contribué à l'impact global du groupe.", 'winbutler.jpg'),
(14, 'Anthony Kiedis', 'Chanteur des Red Hot Chili Peppers', "Anthony Kiedis est le chanteur des Red Hot Chili Peppers. Connu pour son style excentrique et ses paroles personnelles, il a été une force motrice derrière le succès continu du groupe.", 'anthonykiedis.jpg'),
(15, 'Dave Grohl', 'Chanteur des Foo Fighters', "Dave Grohl est le chanteur des Foo Fighters et ancien batteur de Nirvana. Sa polyvalence musicale, son talent en tant que parolier et sa personnalité charismatique en font une figure incontournable du rock moderne.", 'davegrohl.jpg'),
(16, 'Alex Turner', 'Chanteur des Arctic Monkeys', "Alex Turner est le chanteur des Arctic Monkeys. Son approche lyrique distinctive et son charme ont contribué à l'évolution du son des Arctic Monkeys au fil des années.", 'alexturner.jpg'),
(17, 'Matthew Bellamy', 'Chanteur de Muse', "Matthew Bellamy est le chanteur et guitariste principal du groupe Muse. Sa virtuosité musicale et ses performances énergiques ont été au cœur du succès du groupe dans le rock alternatif.", 'matthewbellamy.jpg'),
(18, 'Brandon Flowers', 'Chanteur des Killers', "Brandon Flowers est le chanteur des Killers. Connue pour sa voix distinctive et son style flamboyant, il a été un élément clé du succès commercial du groupe.", 'brandonflowers.jpg'),
(19, 'Billie Joe Armstrong', 'Chanteur de Green Day', "Billie Joe Armstrong est le chanteur de Green Day. Sa personnalité rebelle, son énergie sur scène et ses compétences de composition ont fait de lui une figure emblématique du punk rock.", 'billiejoearmstrong.jpg'),
(20, 'Damon Albarn', 'Chanteur de Blur', "Damon Albarn est le chanteur de Blur et a également été impliqué dans des projets tels que Gorillaz. Sa créativité et sa polyvalence musicale ont contribué à son statut d'artiste influent.", 'damonalbarn.jpg'),
(21, 'Jonny Buckland', 'Guitariste de Coldplay', "Jonny Buckland est le guitariste de Coldplay. Son jeu de guitare distinctif et ses contributions musicales ont joué un rôle essentiel dans le son du groupe.", 'jonnybuckland.jpg'),
(22, 'Jonny Greenwood', 'Compositeur de Radiohead', "Jonathan 'Jonny' Richard Guy Greenwood est un multi-instrumentiste, compositeur et arrangeur britannique né le 5 novembre 1971 à Oxford, membre actif des groupes de rock Radiohead puis The Smile depuis 2021.", 'jonnygreenwood.jpg'),
...
(27, 'Brad Delson', 'Guitariste de Linkin Park', "Bradford Phillip Delson (surnommé Big Bad Brad), né le 1er décembre 1977 à Agoura Hills, est le guitariste soliste et l'un des fondateurs du groupe américain Linkin Park. Il est reconnaissable à son casque qu'il porte à chaque concert.", 'braddelson.jpg'),
(28, 'Jeremy Gara', "Batteur et chanteur d'Arcade Fire", "Jeremy Gara (6 juin 1978 à Ottawa) est un musicien canadien. C'est le batteur du groupe Arcade Fire", 'jeremygara.jpg'),
...
(30, 'Pat Smear', 'Guitariste des Foo Fighters', "Georg Albert Ruthenberg dit Pat Smear est un guitariste de punk, rock et grunge américain, né le 5 août 1959 à Los Angeles (Californie). Il est issu d'un père juif d'origine allemande et d'une mère d'origine afro-américaine et amérindienne.", 'patsmear.jpg'),
